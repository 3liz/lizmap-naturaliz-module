...
class menaceObservationSearch {
    ...
    protected $tplFields = array(
      'remove_menace' => '<a href="{jurl \'mascarine~edit_obs:removeMenace\',array(\'id_obs\'=>$line->id_obs,\'id_obs_menace\'=>$line->id_obs_menace)}" target="_blank" class="remove"><i class="icon-trash"></a>'
    );

    protected $row_id = 'id_obs_menace';

    protected $row_label = Null;

    protected $displayFields = array(
      'type_menace' => array( 'type' => 'string', 'sortable' => "true"),
      'valeur_menace' => array( 'type' => 'string', 'sortable' => "true"),
      'statut_menace' => array( 'type' => 'string', 'sortable' => "true"),
      'remarques_menace' => array( 'type' => 'string', 'sortable' => "0"),
      'remove_menace' => array( 'type' => 'string', 'sortable' => "0")
    );
    ...
    public function __construct ($id, $params=Null) {
        ...
        // Set dao
        $this->dao = jDao::get( 'mascarine~menace_obs' );
