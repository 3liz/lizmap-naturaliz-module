...
INSERT INTO nomenclature VALUES ('niv_val_auto', '6', 'Non évalué', 'Non évalué : c''est un ajout au standard, qui permet de savoir quand la donnée n''a pas encore été évaluée', 6);
...
INSERT INTO nomenclature VALUES ('niv_val_mancom', '3', 'Douteux', 'Douteux : La donnée est peu vraisemblable ou surprenante mais on ne dispose pas d’éléments suffisants pour attester d’une erreur manifeste. La donnée est considérée comme douteuse.', 3);
...
INSERT INTO nomenclature VALUES ('niv_val_mancom', '6', 'Non évalué', 'Non évalué : c''est un ajout au standard, qui permet de savoir quand la donnée n''a pas encore été évaluée', 6);

DELETE FROM nomenclature WHERE champ = 'criticite';
INSERT INTO nomenclature VALUES ('criticite', '1', 'Mineure', 'Mineure : La modification n''est pas de nature à modifier le niveau de validité de la donnée.', 1);
INSERT INTO nomenclature VALUES ('criticite', '2', 'Majeure', 'Majeure : La modification est de nature à modifier le niveau de validité de la donnée.', 2);

DELETE FROM nomenclature WHERE champ = 'typ_val';
INSERT INTO nomenclature VALUES ('typ_val', 'A', 'Automatique', 'Automatique : Résulte d''une validation automatique', 1);
INSERT INTO nomenclature VALUES ('typ_val', 'C', 'Combinée', 'Combinée : Résulte de la combinaison d''une validation automatique et d''une validation manuelle', 2);
INSERT INTO nomenclature VALUES ('typ_val', 'M', 'Manuelle', 'Manuelle : Résulte d''une validation manuelle (intervention d''un expert)', 3);

DELETE FROM nomenclature WHERE champ = 'peri_val';
INSERT INTO nomenclature VALUES ('peri_val', '1', 'Périmètre minimal', 'Périmètre minimal : Validation effectuée sur la base des attributs minimaux, à savoir le lieu, la date, et le taxon.', 1);
INSERT INTO nomenclature VALUES ('peri_val', '2', 'Périmètre maximal', 'Périmètre élargi : validation scientifique sur la base des attributs minimaux, lieu, date, taxon, incluant également des  vérifications sur d''autres attributs, précisés dans la procédure de validation associé.', 2);
