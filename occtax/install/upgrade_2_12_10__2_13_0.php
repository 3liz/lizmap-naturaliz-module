<?php
class occtaxModuleUpgrader_2_12_10__2_13_0 extends jInstallerModule
{

    public $targetVersions = array(
        '2.13.0',
    );
    public $date = '2022-09-23';
    ...
    function install()
    {
        if ($this->firstDbExec()) {
            ...
            $sqlPath = $this->path . 'install/sql/upgrade/upgrade_2.12.10_2.13.0.sql';
