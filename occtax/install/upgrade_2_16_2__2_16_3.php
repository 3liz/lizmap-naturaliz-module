...
class occtaxModuleUpgrader_2_16_2__2_16_3 extends jInstallerModule //\Jelix\Installer\Module\Installer
{
    use upgradeTrait;
    ...
    public $date = '2023-11-10';

    protected $sqlUpgradeFile = 'upgrade/upgrade_2.16.2_2.16.3.sql';
