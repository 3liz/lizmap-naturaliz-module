...
class occtaxModuleUpgrader_2_16_1__2_16_2 extends jInstallerModule //\Jelix\Installer\Module\Installer
{
    use upgradeTrait;
    ...
    public $date = '2023-06-29';

    protected $sqlUpgradeFile = 'upgrade/upgrade_2.16.1_2.16.2.sql';
