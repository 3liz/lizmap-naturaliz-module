<?php
class occtaxModuleUpgrader_2_12_7__2_12_8 extends jInstallerModule
{

    public $targetVersions = array(
        '2.12.8',
    );
    public $date = '2022-07-25';
    ...
    function install()
    {
        if ($this->firstDbExec()) {
            ...
            $sqlPath = $this->path . 'install/sql/upgrade/upgrade_2.12.7_2.12.8.sql';
            $sqlTpl = jFile::read($sqlPath);
            $tpl = new jTpl();
            // CAREFULL, SRID must be UPPERCASE
